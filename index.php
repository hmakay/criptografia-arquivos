<!-- 
Este Sistema de criptografia e decriptografia foi baseado neste sistema:

https://github.com/joelrlneto/criptografia-arquivos-php
...
<html>
  ...
  <body>
    <div class="cabecalho">
        <div class="pic">
            <img src="img/pic.png" alt="SSP" class="logo">
        </div>
        
        <h1>Crypto & Decrypto de arquivos</h1>
       
        <p>SALVE A CHAVE EM UM LOCAL SEGURO</p>
